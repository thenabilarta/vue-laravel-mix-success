...
class DateformatDatatable extends PlatformDataTable
{
    ...
    protected function getColumns()
    {
        return
            [
                'name' => ['data' => 'name', 'title' => trans('settings::dateformat.table.name'), 'data_type' => 'text'],
                'details' => ['data' => 'details', 'title' => trans('settings::dateformat.table.php_format'), 'data_type' => 'text'],
                'js_details' => ['data' => 'js_details', 'title' => trans('settings::dateformat.table.js_format'), 'data_type' => 'text'],
                'created_at' => ['data' => 'created_at', 'title' => trans('settings::dateformat.table.created_at'), 'data_type' => 'datetime'],
                'updated_at' => ['data' => 'updated_at', 'title' => trans('settings::dateformat.table.updated_at'), 'data_type' => 'datetime']
            ];
    }
}
